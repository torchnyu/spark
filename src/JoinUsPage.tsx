      ...
      <div className={classes.container}>
        ...
        <form onSubmit={handleSubmit} className={classes.form}>
          <p>
            ...
            the following form and we'll be in touch
          </p>
          <Box m={1}>
            <TextField
          ...
          <p>
            If you have a GitHub account, please provide your username so that
            we can add you to the Torch organization
          </p>
          <Box m={1}>
            <TextField
              disabled={isSubmitting}
